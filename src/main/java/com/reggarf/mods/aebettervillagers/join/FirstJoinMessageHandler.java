...
@Mod.EventBusSubscriber(modid = AeBetterVillagersMod.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
        ...
        return Component.literal(welcomeMessage.get())
                ...
                .append(Component.literal("[Click here]")
                        .setStyle(Style.EMPTY
                                ...
                                .withUnderlined(true)
                                .withColor(net.minecraft.network.chat.TextColor.fromRgb(0x00FFAA)) // Cyan color
                        ));
    }
}
